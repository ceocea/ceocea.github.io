...
(function() {
  ...
  W.CnvCircleStat = (function() {
    ...
    CnvCircleStat.prototype.createSectorObj = function(rawObj, startAngle) {
      var sObj;
      this.addToPatterns(rawObj.avatar);
      return sObj = {
        id: rawObj.id,
        type: 'MainSector',
        startAngle: startAngle,
        endAngle: startAngle + 2 * Math.PI * (rawObj.chance / 100),
        color: rawObj.color,
        picture: rawObj.avatar,
        percent: rawObj.chance
      };
    };
    ...
    CnvCircleStat.prototype.drawLegend = function(cObj) {
      ...
      this.ctx.fillText('', this.P.centerX + kx * _r, this.P.centerY + ky * _r + 4);
      this.ctx.beginPath();
